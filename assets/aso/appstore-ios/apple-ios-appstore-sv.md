...
• Full kontroll: Du äger dina privata nycklar — inte vi.
• Solana & SPL-tokens: Snabba, billiga transaktioner byggda direkt på Solana.
...
Enkel design. Hög hastighet. Fullständig frihet.
Byggd för Solana — för dig som värdesätter kontroll, säkerhet och självständighet.
